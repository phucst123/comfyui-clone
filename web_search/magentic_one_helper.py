...
class MagenticOneHelper:
    def __init__(self, logs_dir: str, download_dir: str, save_screenshots: bool = False) -> None:
        """
    ...
    async def initialize(self, start_page: str) -> None:
        """
        ...
        agent_list = [web_surfer, file_surfer]
        ...
        await actual_surfer.init(
            model_client=client,
            downloads_folder=self.download_dir,
